            ...
            <div class="card-container">
                <div class="card">
                    ...
                    <div class="card-text">
                        ...
                        <p class="card-p">Created using a Node.JS backend. Express server, MongoDB and ejs to display data on the frontend.</p>
                        <div class="card-text-more">
                            <a href="#" class="more" title="view">
                            ...
                            <a href="#" class="more" title="github">
                            ...
                            <a href="/blog.html" class="more" title="Case Study">
